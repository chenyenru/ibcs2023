...
def draw_menu(ctx: dict, menu: dict) -> callable:
    ...
    while key != 27:
        ...
        # if key is enter
            ...
            # this selects the "active" option and return callback
...
if __name__ == '__main__':
    ...
    menu = {
        ...
        OPTIONS: [
            # The None is where we're going to put the callback
